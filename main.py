...
def generate_pdf():
    try:
        ...
        try:
            ...
            detailed_anchor_data = [
                ['Anchor Text', 'Category', 'Count', 'Percentage', 'Link Quality'],
                ['Insurance Services Dubai', 'Exact Match Keywords', 45, '18.2%', 'High'],
                ['Hosn Insurance', 'Branded Anchors', 38, '15.4%', 'High'],
                ['click here', 'Generic Anchors', 32, '13.0%', 'Low'],
                ['car insurance UAE', 'Exact Match Keywords', 28, '11.3%', 'High'],
                ['https://hosninsurance.ae', 'URL Anchors', 24, '9.7%', 'Medium'],
                ['read more', 'Generic Anchors', 22, '8.9%', 'Low'],
                ['Hosn Insurance Company', 'Branded Anchors', 18, '7.3%', 'High'],
                ['vehicle insurance', 'Exact Match Keywords', 15, '6.1%', 'Medium'],
                ['www.hosninsurance.ae', 'URL Anchors', 12, '4.9%', 'Medium'],
                ['learn more about insurance', 'Generic Anchors', 8, '3.2%', 'Low'],
                ['home insurance Dubai', 'Exact Match Keywords', 5, '2.0%', 'Medium']
            ]
